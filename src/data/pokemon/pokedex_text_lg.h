const u8 gDummyPokedexText[] = _(
    ...
    "under undersoegelse. Ingen detaljeret\n"
    "information er tilgaengelig endnu.");
...
const u8 gIvysaurPokedexText[] = _(
    "Naar loegen paa ryggen bliver stor, taber\n"
    "den tilsyneladende evnen til at staae paa\n"
    "bagbenene.");
...
const u8 gCharmanderPokedexText[] = _(
    "Den foretraekker varme ting.\n"
    "Naar det regner, siges damp at sprudle fra\n"
    "spidsen af halen.");

const u8 gCharmanderPokedexTextUnused[] = _("");

const u8 gCharmeleonPokedexText[] = _(
    "Naar den svinger sin braendende hale,\n"
    "hoejer den lufttemperaturen til\n"
    "utroligt hoeje niveauer.");

const u8 gCharmeleonPokedexTextUnused[] = _("");

const u8 gCharizardPokedexText[] = _(
    "Den spytter ild der er varm nok til at\n"
    "smelte klippeblokke. Kan foraarsage\n"
    "skovbraende med flammer.");

const u8 gCharizardPokedexTextUnused[] = _("");

const u8 gSquirtlePokedexText[] = _(
    "Efter foedslen svaeller og haerdner ryggen\n"
...
const u8 gBlastoisePokedexText[] = _(
    "De trykluftsede vandstraaler paa denne\n"
    "brutale POKeMONs skjold bruges til\n"
    "hoejhastigheds-tackles.");

const u8 gBlastoisePokedexTextUnused[] = _("");

const u8 gCaterpiePokedexText[] = _(
    "Dens korte foedder har sugekopper der\n"
    "goer at den utraetteligt kan kravle op ad\n"
    "skraaninger og vaegge.");

const u8 gCaterpiePokedexTextUnused[] = _("");

const u8 gMetapodPokedexText[] = _(
    "Denne POKeMON er sarbar over for angreb\n"
    "naar dens skal er bloed og afsloerer sin\n"
    "svage og bloede krop.");

const u8 gMetapodPokedexTextUnused[] = _(
    " ");

const u8 gButterfreePokedexText[] = _(
    "I kamp slaaer den vingerne med stor\n"
    "hastighed for at frigive staerkt giftigt\n"
    "stoev i luften.");
...
const u8 gKakunaPokedexText[] = _(
    "Almost incapable of moving, this POKeMON\n"
...
const u8 gPidgeyPokedexText[] = _(
    "Almindeligt syn i skove og loevskove.\n"
    "Den slaaer vingerne i jordhoejde for at\n"
    "virvle forblaendende sand op.");
...
const u8 gPidgeottoPokedexText[] = _(
    ...
    "pikke enhver indtraenger.");

const u8 gPidgeottoPokedexTextUnused[] = _("");

const u8 gPidgeotPokedexText[] = _(
    "Naar den jager, skimmer den vandoverfladen\n"
    "i hoej hastighed for at fange uforsigtigt\n"
    "bytte som MAGIKARP.");

const u8 gPidgeotPokedexTextUnused[] = _("");

const u8 gRattataPokedexText[] = _(
    "Bider alt naar den angriber. Lille og meget\n"
...
const u8 gRaticatePokedexText[] = _(
    ...
    "balancen. Den saenker tilsyneladende\n"
    "farten hvis de klippes af.");

const u8 gRaticatePokedexTextUnused[] = _("");

const u8 gSpearowPokedexText[] = _(
    "Spiser insekter i graesbevoksede omraader.\n"
    "Den maa slaa de korte vinger i hoej\n"
...
const u8 gEkansPokedexText[] = _(
    "Bevaeger sig lydloest og snigende og spiser\n"
    "fuglenes aeg hele, saasom fra PIDGEY\n"
    "og SPEAROW.");

const u8 gEkansPokedexTextUnused[] = _("");

const u8 gArbokPokedexText[] = _(
    "Rygtet siger at de vilde advarselstegn paa\n"
    "dens mave varierer fra omraade til\n"
    "omraade.");

const u8 gArbokPokedexTextUnused[] = _("");

const u8 gPikachuPokedexText[] = _(
    "Naar flere af disse POKeMON samles kan\n"
    "deres elektricitet ophobes og foraarsage\n"
    "tordenvejr.");
...
const u8 gRaichuPokedexText[] = _(
    ...
    "beskytte sig mod sin egen hoejspaendings-\n"
    "kraft.");
...
const u8 gNidoranFPokedexText[] = _(
    "Selvom lille goer dens giftige brodder\n"
...
const u8 gNidorinaPokedexText[] = _(
    ...
    "Foretraekker fysiske angreb som kloen og\n"
    "biden.");

const u8 gNidorinaPokedexTextUnused[] = _("");

const u8 gNidoqueenPokedexText[] = _(
    "Dens haarde skael giver staerk beskyttelse.\n"
    "Den bruger sin tunge masse til at udfoere\n"
    "kraftige traek.");

const u8 gNidoqueenPokedexTextUnused[] = _("");

const u8 gNidoranMPokedexText[] = _(
    "Den stivner oerene for at maerke fare.\n"
    "Jo stoerre hornene er, jo staerkere er\n"
    "det udskilte gift.");
...
const u8 gNidorinoPokedexText[] = _(
    ...
    "Hornet paa hovedet udskiller et\n"
    "kraftigt gift.");
...
const u8 gNidokingPokedexText[] = _(
    ...
    "slaa, klemme og saa knuse byttets\n"
    "knogler.");

const u8 gNidokingPokedexTextUnused[] = _("");

const u8 gClefairyPokedexText[] = _(
    "Med sin magiske og soedme har den mange\n"
    "beundrere. Den er sjaelden og findes kun\n"
    "i visse omraader.");

const u8 gClefairyPokedexTextUnused[] = _("");

const u8 gClefablePokedexText[] = _(
    "En frygtsom fe-POKeMON der sjaelden ses.\n"
    "Den loeber og gemmer sig det oejeblik den\n"
    "maerker mennesker.");

const u8 gClefablePokedexTextUnused[] = _("");

const u8 gVulpixPokedexText[] = _(
    "Ved foedslen har den kun een snehvid hale.\n"
    "Halen deler sig fra spidsen naar den\n"
    "bliver aeldre.");

const u8 gVulpixPokedexTextUnused[] = _("");

const u8 gNinetalesPokedexText[] = _(
    "Meget klog og meget haevngerrig. At gribe\n"
    "en af dens mange haler kan resultere i en\n"
    "forbandelse paa 1.000 aar.");

const u8 gNinetalesPokedexTextUnused[] = _("");

const u8 gJigglypuffPokedexText[] = _(
    "Naar dens enorme oejne svaever synger den en\n"
    "gaadefuld beroligende melodi der luller\n"
    "sine fjender i soevn.");

const u8 gJigglypuffPokedexTextUnused[] = _("");

const u8 gWigglytuffPokedexText[] = _(
    "Kroppen er bloed og gummagtig. Naar den\n"
    "bliver vred suger den luft ind og blaeser\n"
    "sig op til en enorm stoerrelse.");

const u8 gWigglytuffPokedexTextUnused[] = _("");

const u8 gZubatPokedexText[] = _(
    "Den danner kolonier i evigt moerke steder\n"
...
const u8 gParasPokedexText[] = _(
    "Graever for at suge traeroedder. Svampene\n"
    "paa ryggen vokser ved at traekke naering\n"
    "fra insektvaerten.");

const u8 gParasPokedexTextUnused[] = _("");

const u8 gParasectPokedexText[] = _(
    "Et vaerts-parasit-par hvor parasitsvampen\n"
    "har overtaget insektvaerten. Foretraekker\n"
    "fugtige steder.");

const u8 gParasectPokedexTextUnused[] = _("");

const u8 gVenonatPokedexText[] = _(
    "Lever i skyggerne af hoeje traeer hvor den\n"
    "spiser insekter. Den tiltraekkes af lys\n"
    "om natten.");

const u8 gVenonatPokedexTextUnused[] = _("");

const u8 gVenomothPokedexText[] = _(
    "De stoevagtige skael paa vingerne er\n"
...
const u8 gDiglettPokedexText[] = _(
    ...
    "den lever af planteroedder. Den viser sig\n"
...
const u8 gDugtrioPokedexText[] = _(
    ...
    "udloeser enorme jordskaelv ved at graeve\n"
    "100 km under jorden.");
...
const u8 gPsyduckPokedexText[] = _(
    ...
    "look, this wily POKeMON will use\n"
...
const u8 gMankeyPokedexText[] = _(
    ...
    "vaere tam et oejeblik og slaas loos i\n"
    "naeste sekund.");
...
const u8 gPrimeapePokedexText[] = _(
    ...
    "ikke op med at jagte byttet foer den har\n"
    "indhentet det.");
...
const u8 gArcaninePokedexText[] = _(
    "En POKeMON der laenge har vaeret beundret\n"
    "for sin skoenhed. Den loeber smidigt som\n"
    "paa vinger.");
...
const u8 gPoliwagPokedexText[] = _(
    ...
    "gaa ordentligt. Den foretraekker\n"
    "tilsyneladende at svomme fremfor at gaa.");
...
const u8 gPoliwrathPokedexText[] = _(
    "En svommer der behersker baade crawl og\n"
...
const u8 gMachokePokedexText[] = _(
    "Dens muskuloese krop er saa kraftig at den\n"
    "maa baere et kraeftbaelte for at kunne\n"
    "regulere sine bevaegelser.");

const u8 gMachokePokedexTextUnused[] = _("");

const u8 gMachampPokedexText[] = _(
    "Dens superkraftige slag siges at slaa\n"
    "offeret flyvende helt over horisonten.");

const u8 gMachampPokedexTextUnused[] = _("");

const u8 gBellsproutPokedexText[] = _(
    "A carnivorous POKeMON that traps and eats\n"
...
const u8 gGeodudePokedexText[] = _(
    ...
    "dem ofte med kampesten og traeder eller\n"
    "snubler over dem.");

const u8 gGeodudePokedexTextUnused[] = _("");

const u8 gGravelerPokedexText[] = _(
    "Ruller ned ad skraaninger for at bevaege\n"
    "sig. Den ruller over enhver forhindring\n"
    "uden at saenke farten eller aendre retning.");
...
const u8 gPonytaPokedexText[] = _(
    "Dens hover er ti gange haardere end\n"
...
const u8 gRapidashPokedexText[] = _(
    "Very competitive, this POKeMON will chase\n"
...
const u8 gSlowpokePokedexText[] = _(
    ...
    "sekunder foer den maerker smerte under\n"
    "angreb.");
...
const u8 gGrimerPokedexText[] = _(
    "Optraeder i beskidte omraader. Den trives\n"
...
const u8 gMukPokedexText[] = _(
    "Tykt daekket med aekelt, grufuldt slam.\n"
    "Den er saa giftig at selv dens fodspor\n"
    "indeholder gift.");

const u8 gMukPokedexTextUnused[] = _("");

const u8 gShellderPokedexText[] = _(
    "Dens haarde skal afviser ethvert angreb.\n"
    "Den er kun sarbar naar skallen er\n"
    "aaben.");
...
const u8 gGastlyPokedexText[] = _(
    "Naesten usynlig hylder denne gasagtige\n"
    "POKeMON maalet og putter det i soevn\n"
    "uden varsel.");
...
const u8 gGengarPokedexText[] = _(
    "Paa fuldmaane nat, hvis skygger bevaeger sig\n"
    "selv og griner, maa det vaere GENGARs\n"
    "vaerk.");

const u8 gGengarPokedexTextUnused[] = _("");

const u8 gOnixPokedexText[] = _(
    "Efterhaanden som den vokser haerdner\n"
...
const u8 gDrowzeePokedexText[] = _(
    "Putter fjender i soevn og spiser derefter\n"
    "deres dromme. Bliver lejlighedsvis syg af\n"
    "kun at spise daarlige dromme.");

const u8 gDrowzeePokedexTextUnused[] = _("");

const u8 gHypnoPokedexText[] = _(
    "Naar den fanger en fjendes blik bruger den\n"
    "en blanding af PSI-traek som HYPNOSIS og\n"
    "CONFUSION.");

const u8 gHypnoPokedexTextUnused[] = _("");

const u8 gKrabbyPokedexText[] = _(
    "Dens kloer er ikke kun kraftige vaaben,\n"
    "de bruges til balance naar den gaar\n"
    "sidelaens.");

const u8 gKrabbyPokedexTextUnused[] = _("");

const u8 gKinglerPokedexText[] = _(
    "Den store klo har 10.000 hestekraefter\n"
    "knusekraft. Men den enorme stoerrelse\n"
    "goer den besvaerlig at bruge.");

const u8 gKinglerPokedexTextUnused[] = _("");

const u8 gVoltorbPokedexText[] = _(
    "Findes usually i kraftvaerker. Forveksles\n"
...
const u8 gExeggcutePokedexText[] = _(
    "Den forveksles ofte med aeg. Naar den\n"
...
const u8 gExeggutorPokedexText[] = _(
    "Det siges at en af dens hoveder sjaelden\n"
    "falder af og fortsaetter som en\n"
    "EXEGGCUTE.");
...
const u8 gMarowakPokedexText[] = _(
    "Knoglen den holder er dens vigtigste vaaben.\n"
    "Den kaster knoglen oevet som en\n"
    "boomerang for at slaa ud maal.");

const u8 gMarowakPokedexTextUnused[] = _("");

const u8 gHitmonleePokedexText[] = _(
    "Naar den har travlt forlaenges benene\n"
    "gradvist. Den loeber jaevnt med ekstra\n"
    "lange skridt.");

const u8 gHitmonleePokedexTextUnused[] = _("");

const u8 gHitmonchanPokedexText[] = _(
    "Mens den tilsyneladende ikke goer noget\n"
...
const u8 gLickitungPokedexText[] = _(
    "Dens tunge kan straekkes ud som en\n"
    "kamaeleons. Den efterlader en prikkende\n"
    "fornemmelse naar den slikker fjender.");

const u8 gLickitungPokedexTextUnused[] = _("");

const u8 gKoffingPokedexText[] = _(
    "Da den lagrer flere slags giftige gasser i\n"
    "kroppen er den tilboejelig til at\n"
    "eksplodere uden advarsel.");

const u8 gKoffingPokedexTextUnused[] = _("");

const u8 gWeezingPokedexText[] = _(
    "Hvor to slags giftgasser moedes kan to\n"
    "KOFFING over mange aar smelte sammen til\n"
    "en WEEZING.");
...
const u8 gRhyhornPokedexText[] = _(
    ...
    "haardere end menneskeknogler. Dens TACKLE\n"
    "kan slaa en semitrailer flyvende.");

const u8 gRhyhornPokedexTextUnused[] = _("");

const u8 gRhydonPokedexText[] = _(
    "Beskyttet af et panseragtigt skind kan den\n"
    "leve i smeltet lava paa 3.600 grader\n"
    "Fahrenheit.");

const u8 gRhydonPokedexTextUnused[] = _("");

const u8 gChanseyPokedexText[] = _(
    "En sjaelden og flygtig POKeMON der siges at\n"
    "bringe lykke til dem der formaaer at\n"
    "fange en.");
...
const u8 gTangelaPokedexText[] = _(
    ...
    "der ligner tang. Planterne vaeger naar\n"
    "den gaar.");

const u8 gTangelaPokedexTextUnused[] = _("");

const u8 gKangaskhanPokedexText[] = _(
    "Ungenen vover sig sjaelden ud af sin\n"
    "mors beskyttende pung foer den er\n"
    "tre aar gammel.");
...
const u8 gHorseaPokedexText[] = _(
    ...
    "med praecise blaekkskud fra vandoverfladen.");

const u8 gHorseaPokedexTextUnused[] = _("");

const u8 gSeadraPokedexText[] = _(
    "Den kan svomme baglaens ved hurtigt at\n"
    "slaa med de vingelignende brystfinner og\n"
    "den korte hale.");
...
const u8 gSeakingPokedexText[] = _(
    "I efteraars ynglesaesonen kan de ses\n"
...
const u8 gStaryuPokedexText[] = _(
    "En gaadefuld POKeMON der ubesvaeret kan\n"
...
const u8 gJynxPokedexText[] = _(
    "Den vrikker forfoerende med hofterne naar\n"
    "den gaar. Den kan faa folk til at danse\n"
    "i takt med den.");

const u8 gJynxPokedexTextUnused[] = _("");

const u8 gElectabuzzPokedexText[] = _(
    "Normalt findes naer kraftvaerker, de kan\n"
    "vandre vaek og foraarsage store\n"
    "stroemafbrydelser i byer.");
...
const u8 gTaurosPokedexText[] = _(
    "Naar den sigter paa en fjende, stormer den\n"
...
const u8 gMagikarpPokedexText[] = _(
    "I fjerne fortid var den noget staerkere\n"
    "end de forfaerdeligt svage efterkommere\n"
    "der findes i dag.");

const u8 gMagikarpPokedexTextUnused[] = _("");

const u8 gGyaradosPokedexText[] = _(
    "Sjaeldent set i naturen. Enorm og voldsom,\n"
    "den er i stand til at odelaegge hele byer\n"
    "i et raserianfald.");

const u8 gGyaradosPokedexTextUnused[] = _("");

const u8 gLaprasPokedexText[] = _(
    "Et POKeMON der er blevet overjagt naesten\n"
    "til udryddelse. Den kan fragte folk paa\n"
    "ryggen.");
...
const u8 gDittoPokedexText[] = _(
    ...
    "genetiske kode for oejeblikkeligt at\n"
    "forvandle sig til en kopi af fjenden.");

const u8 gDittoPokedexTextUnused[] = _("");

const u8 gEeveePokedexText[] = _(
    "Dens genetiske kode er uregelmaessig. Den\n"
    "kan mutere hvis den udsaettes for\n"
    "straaling fra element STONES.");

const u8 gEeveePokedexTextUnused[] = _("");

const u8 gVaporeonPokedexText[] = _(
    "Lever taet paa vand. Dens lange hale er\n"
...
const u8 gJolteonPokedexText[] = _(
    ...
    "atmosfaeren for at affyre 10.000 volt\n"
    "lynstraler.");

const u8 gJolteonPokedexTextUnused[] = _("");

const u8 gFlareonPokedexText[] = _(
    "Naar den lagrer termisk energi i kroppen,\n"
...
const u8 gPorygonPokedexText[] = _(
    "Et POKeMON der udelukkende bestaar af\n"
    "programmerkode. Det kan bevaege sig\n"
    "frit i cyberspace.");
...
const u8 gOmastarPokedexText[] = _(
    "Trods staerke hugtaender og tentakler\n"
    "uddoede den da dens tunge skal gjorde den\n"
    "ude af stand til at fange bytte.");

const u8 gOmastarPokedexTextUnused[] = _("");

const u8 gKabutoPokedexText[] = _(
    "A POKeMON that was regenerated from a\n"
...
const u8 gAerodactylPokedexText[] = _(
    "A ferocious, prehistoric POKeMON that\n"
...
const u8 gArticunoPokedexText[] = _(
    "A legendary bird POKeMON that is said to\n"
...
const u8 gDragonairPokedexText[] = _(
    "Et mystisk POKeMON der udstraaler en blid\n"
...
const u8 gDragonitePokedexText[] = _(
    ...
    "POKeMON. Its intelligence is said to\n"
...
const u8 gMewPokedexText[] = _(
    "Sa sjaelden at den stadig siges at vaere et\n"
    "luftspejlbillede af mange eksperter. Kun\n"
    "faa mennesker har set den verden over.");
...
const u8 gBayleefPokedexText[] = _(
    ...
    "dens hals. Paa en eller anden maade faar\n"
    "snusen dig til at ville kaempe.");
...
const u8 gTyphlosionPokedexText[] = _(
    "Hvis dens vrede naar toppen, bliver den saa\n"
    "varm at alt der roerer den vil oejeblikkeligt\n"
    "gaa op i flammer.");
...
const u8 gCroconawPokedexText[] = _(
    "Hvis den mister en hugtaand, vokser en ny\n"
    "tilbage paa pladsen. Der er altid 48\n"
    "hugtaender langs munden.");
...
const u8 gSentretPokedexText[] = _(
    ...
    "op med halen for at faa bedre overblik over\n"
    "omgivelserne.");
...
const u8 gHoothootPokedexText[] = _(
    "Den staar altid paa een fod. Den skifter\n"
    "fod saa hurtigt at bevaegelsen sjaeldent\n"
    "kan ses.");

const u8 gHoothootPokedexTextUnused[] = _("");

const u8 gNoctowlPokedexText[] = _(
    "Dens oejne er specielt tilpasset. De\n"
    "koncentrerer selv svagt lys og goer den i\n"
    "stand til at se i moerket.");

const u8 gNoctowlPokedexTextUnused[] = _("");

const u8 gLedybaPokedexText[] = _(
    "Den er meget sky. Den vil vaere bange for at\n"
    "bevaege sig hvis den er alene. Men den vil\n"
    "vaere aktiv hvis den er i en gruppe.");
...
const u8 gAriadosPokedexText[] = _(
    "Den spinder traad ikke kun bagfra men ogsaa\n"
    "fra munden. Det er svaert at sige hvilken\n"
    "ende der er hvilken.");

const u8 gAriadosPokedexTextUnused[] = _("");

const u8 gCrobatPokedexText[] = _(
    "Den flyver saa lydloest gennem moerket paa\n"
    "sine fire vinger at den maaske ikke bliver\n"
    "lagt maerke til selv naar den er naer.");

const u8 gCrobatPokedexTextUnused[] = _("");

const u8 gChinchouPokedexText[] = _(
    "Den affyrer positiv og negativ stroem mellem\n"
...
const u8 gLanturnPokedexText[] = _(
    "Lyset den udsender er saa kraftigt at den\n"
    "kan belyse havoverfladen fra en dybde paa\n"
    "over tre mil.");
...
const u8 gCleffaPokedexText[] = _(
    "Paa grund af sin usaedvanlige, stjerne-\n"
...
const u8 gTogepiPokedexText[] = _(
    "Skallet synes at vaere fyldt med glaede.\n"
    "Det siges at den deler lykke naar den\n"
    "behandles venligt.");
...
const u8 gAmpharosPokedexText[] = _(
    ...
    "langt vaek. Den virker som et fyr for\n"
    "fortabte mennesker.");
...
const u8 gAzumarillPokedexText[] = _(
    "Ved at holde sig stille og lytte opmaerksomt\n"
    "kan den endda sige hvad der er i vilde,\n"
    "hurtigt stroemmende floder.");
...
const u8 gAipomPokedexText[] = _(
    "Dens hale er saa kraftig at den kan bruge\n"
...
const u8 gYanmaPokedexText[] = _(
    "Hvis den slaaer med vingerne rigtig hurtigt,\n"
    "kan den skabe chokboelger der smadrer\n"
    "vinduer i omraadet.");
...
const u8 gUmbreonPokedexText[] = _(
    "When agitated, this POKeMON protects\n"
...
const u8 gMisdreavusPokedexText[] = _(
    ...
    "skrige og hyle for at skraemme folk om\n"
    "natten. ");
...
const u8 gDunsparcePokedexText[] = _(
    "Naar den opdages, flygter dette POKeMON\n"
    "baglaens ved vildt at bore ned i jorden\n"
    "med halen.");

const u8 gDunsparcePokedexTextUnused[] = _("");

const u8 gGligarPokedexText[] = _(
    "Den flyver lige mod maalets ansigt, og\n"
    "klemmer saa ned om det forskraekkede\n"
...
const u8 gSteelixPokedexText[] = _(
    ...
    "jorden. Som folge er den endnu haerdere\n"
    "end diamant.");

const u8 gSteelixPokedexTextUnused[] = _("");

const u8 gSnubbullPokedexText[] = _(
    "Selvom den ser skraemmende ud, er den\n"
    "faktisk venlig og kaerlig. Den er meget\n"
    "populaer blandt kvinder.");

const u8 gSnubbullPokedexTextUnused[] = _("");

const u8 gGranbullPokedexText[] = _(
    "Den er faktisk sky og let at skraemme.\n"
    "Hvis den angribes, slaaer den vildt omkring\n"
    "for at afvaerge angriberen.");

const u8 gGranbullPokedexTextUnused[] = _("");

const u8 gQwilfishPokedexText[] = _(
    "For at affyre sine giftige pigge maa den\n"
    "blaese kroppen op ved at drikke over 2,6\n"
    "gallon vand paa een gang.");
...
const u8 gHeracrossPokedexText[] = _(
    "This powerful POKeMON thrusts its prized\n"
...
const u8 gSneaselPokedexText[] = _(
    "Dens poter skjuler skarpe kloer. Hvis den\n"
    "angribes, straekker den pludseligt kloerne\n"
    "ud og skraemmer fjenden.");

const u8 gSneaselPokedexTextUnused[] = _("");

const u8 gTeddiursaPokedexText[] = _(
    "Hvis den finder honning, lyser dens\n"
    "halvmaane-maerke. Den slikker altid sine\n"
    "poter fordi de er gennembloedte med honning.");

const u8 gTeddiursaPokedexTextUnused[] = _("");

const u8 gUrsaringPokedexText[] = _(
    "Selvom den er en god klatrer, foretraekker\n"
    "den at knaekke staerke traeer med forbenene\n"
    "og spise faldne BERRIES.");

const u8 gUrsaringPokedexTextUnused[] = _("");

const u8 gSlugmaPokedexText[] = _(
    "Den sover aldrig. Den maa blive ved med at\n"
    "bevaege sig fordi hvis den stoppede, ville\n"
    "dens magmakrop koele og haerdne.");

const u8 gSlugmaPokedexTextUnused[] = _("");

const u8 gMagcargoPokedexText[] = _(
    "Skallet paa ryggen er bare hud der er\n"
    "afkolet og haerdnet. Det gaar let i stykker\n"
    "ved en let beroering.");
...
const u8 gPiloswinePokedexText[] = _(
    "Fordi det lange haar over hele kroppen\n"
    "tager synet, loeber den bare loes igen og\n"
    "igen.");
...
const u8 gCorsolaPokedexText[] = _(
    ...
    "af hovedet vaerdsaettes som en skat for\n"
    "dens skoenhed.");

const u8 gCorsolaPokedexTextUnused[] = _("");

const u8 gRemoraidPokedexText[] = _(
    "Den har enestaaende praecision. Vandet den\n"
    "skyder ud kan ramme selv bevaegeligt bytte\n"
    "fra over 100 meter.");
...
const u8 gOctilleryPokedexText[] = _(
    ...
    "synede tentakler og smadrer dem saa med\n"
    "sit stenhaarde hoved.");

const u8 gOctilleryPokedexTextUnused[] = _("");

const u8 gDelibirdPokedexText[] = _(
    "Den baerer mad hele dagen. Der fortaelles\n"
...
const u8 gMantinePokedexText[] = _(
    "Naar den svommer majestaetisk, er den ligeglad\n"
    "med om REMORAID haenger paa for at aede\n"
    "dens rester.");
...
const u8 gHoundoomPokedexText[] = _(
    "Bliver du braendt af flammerne den skyder\n"
    "fra munden, vil smerten aldrig gaae\n"
    "vaek.");
...
const u8 gKingdraPokedexText[] = _(
    ...
    "undervandshuler. Den kan skabe malstroemme\n"
    "ved at gabe.");
...
const u8 gStantlerPokedexText[] = _(
    "Dens buede gevir aendrer luftstroemmen\n"
    "subtilt og skaber et maerkeligt rum hvor\n"
    "virkeligheden forvraenges.");

const u8 gStantlerPokedexTextUnused[] = _("");

const u8 gSmearglePokedexText[] = _(
    "En saerlig vaeske siver fra halens spids.\n"
    "dens hale. Den maler vaesken overalt for\n"
...
const u8 gTyroguePokedexText[] = _(
    ...
    "staerkere kaemper den videre selv om den\n"
    "taber.");

const u8 gTyroguePokedexTextUnused[] = _("");

const u8 gHitmontopPokedexText[] = _(
    "Bliver du fortryllet af dens bloede,\n"
    "elegante, danselignende spark, kan du\n"
    "faa sig en ordentlig omgang.");

const u8 gHitmontopPokedexTextUnused[] = _("");

const u8 gSmoochumPokedexText[] = _(
    "Dens laeber er de mest foelsomme steder paa\n"
    "kroppen. Den bruger altid laeberne foerst\n"
    "til at undersoege ting.");

const u8 gSmoochumPokedexTextUnused[] = _("");

const u8 gElekidPokedexText[] = _(
    "Den roterer armene for at skabe stroem,\n"
    "men den bliver let traeet, saa den\n"
...
const u8 gMiltankPokedexText[] = _(
    "Dens maelk er fuld af naering og er den\n"
    "ultimative drik til syge eller traette.");

const u8 gMiltankPokedexTextUnused[] = _("");

const u8 gBlisseyPokedexText[] = _(
    "Den der tager bare et enkelt bid af\n"
    "BLISSEYs aeg bliver ufejlbarligt omsorgs-\n"
...
const u8 gHoOhPokedexText[] = _(
    "Legends claim this POKeMON flies the\n"
...
const u8 gCelebiPokedexText[] = _(
    ...
    "Graes og traeer blomstrer i skovene\n"
...
const u8 gSceptilePokedexText[] = _(
    "Bladene paa forbenene er skarpe som\n"
    "svaerd. Den hopper smidigt mellem grene\n"
    "for at slaa til.");
...
const u8 gCombuskenPokedexText[] = _(
    "Den oeger koncentrationen ved at udstoede\n"
    "haarde skrig. Dens spark har enestaaende\n"
    "oedelaeggelsesevne.");

const u8 gCombuskenPokedexTextUnused[] = _("");

const u8 gBlazikenPokedexText[] = _(
    "Naar den moeder en haard modstander, sender\n"
    "den flammer fra haandleddene. Dens staerke\n"
...
const u8 gSwampertPokedexText[] = _(
    "Dens arme er stenhaarde. Med et sving kan\n"
    "den slaa fjenden ned. Den bygger rede paa\n"
    "skoenne strande.");
...
const u8 gLinoonePokedexText[] = _(
    "Naar den loeber lige ud kan den naa over 60\n"
    "mph. Den har dog svaert ved svingede veje.");

const u8 gLinoonePokedexTextUnused[] = _("");

const u8 gWurmplePokedexText[] = _(
    "Den lever i hoej graes og i skove. Naar den\n"
    "angribes, saetter den sine giftige pigge\n"
    "mod fjenden.");

const u8 gWurmplePokedexTextUnused[] = _("");

const u8 gSilcoonPokedexText[] = _(
    "Den sparer energi ved at bevaege sig saa\n"
    "lidt som muligt. Den venter paa evolution\n"
...
const u8 gDustoxPokedexText[] = _(
    "Den spreder gruopvaekkende giftigt stoev\n"
    "naar den maerker fare. De samles ofte i\n"
    "gadebelysningens skaer om natten.");

const u8 gDustoxPokedexTextUnused[] = _("");

const u8 gLotadPokedexText[] = _(
    "Den soeger efter rent vand. Drikker den\n"
    "ikke vand for laenge, visner bladet paa\n"
    "hovedet.");
...
const u8 gPelipperPokedexText[] = _(
    "Den er en flyvende transportoer der baerer\n"
    "smaa POKeMON i naebbet. Den dupper paa\n"
    "boelgerne for at hvile vingerne.");

const u8 gPelipperPokedexTextUnused[] = _("");

const u8 gRaltsPokedexText[] = _(
    "Den er meget afstemt paa folelser hos\n"
    "mennesker og POKeMON. Den gemmer sig\n"
    "naar den maerker fjendtlighed.");

const u8 gRaltsPokedexTextUnused[] = _("");

const u8 gKirliaPokedexText[] = _(
    "TRAINERens muntre aand giver den energi\n"
    "til sin psykokinetiske kraft. Den snurrer\n"
    "og danser naar den er glad.");
...
const u8 gSurskitPokedexText[] = _(
    "De lever som regel paa damme, men efter et\n"
...
const u8 gMasquerainPokedexText[] = _(
    "Antennerne har saerlige moenstere der\n"
    "ligner oejne. Naar det regner, bliver de\n"
    "tunge og flyvning umuliggoeres.");
...
const u8 gSlakothPokedexText[] = _(
    "Den sover 20 timer hver dag. At goere\n"
    "dem der ser den doese er en af dens\n"
    "evner.");
...
const u8 gVigorothPokedexText[] = _(
    ...
    "med at rage. Selv naar den spiser kan den\n"
...
const u8 gSlakingPokedexText[] = _(
    ...
    "kan udvise skraekindjagende kraft ved at\n"
    "slippe opbygget energi loes paa een gang.");

const u8 gSlakingPokedexTextUnused[] = _("");

const u8 gNincadaPokedexText[] = _(
    "Fordi den levede naesten helt under jorden,\n"
    "er den naesten blind. Den bruger i stedet\n"
    "sine antenner.");

const u8 gNincadaPokedexTextUnused[] = _("");

const u8 gNinjaskPokedexText[] = _(
    "Denne POKeMON er saa hurtig at den siges at\n"
    "kunne undgaa ethvert angreb. Den elsker\n"
    "at aede traesaft.");

const u8 gNinjaskPokedexTextUnused[] = _("");

const u8 gShedinjaPokedexText[] = _(
    "En meget ejendommelig POKeMON der paa\n"
    "mystisk vis dukker op i en POKe BALL naar\n"
    "en NINCADA udvikler sig.");

const u8 gShedinjaPokedexTextUnused[] = _("");

const u8 gWhismurPokedexText[] = _(
    "Den mumler som regel, men begynder at graede\n"
    "hoejt hvis den maerker fare. Den stopper\n"
    "naar oerekassetterne er lukkede.");

const u8 gWhismurPokedexTextUnused[] = _("");

const u8 gLoudredPokedexText[] = _(
    "Naar den stamper med foedderne og broeler,\n"
    "skaber den ultralydsboelger der kan blaese\n"
    "et hus i stykker.");
...
const u8 gExploudPokedexText[] = _(
    ...
    "over hele kroppen. Dens hoeje skrig kan\n"
    "hoeres fra over ti kilometer borte.");

const u8 gExploudPokedexTextUnused[] = _("");

const u8 gMakuhitaPokedexText[] = _(
    "Den bliver staerkere ved at udsta haard\n"
    "traening. Den er en modig POKeMON der kan\n"
    "taale ethvert angreb.");
...
const u8 gAzurillPokedexText[] = _(
    "Den kaemper ved at svinge halen rundt - den\n"
    "er stoerre end kroppen. Halen er en\n"
    "flydeevne i vand.");

const u8 gAzurillPokedexTextUnused[] = _("");

const u8 gNosepassPokedexText[] = _(
    "Dens magnetiske naese peger altid mod nord.\n"
...
const u8 gSkittyPokedexText[] = _(
    "Det siges at vaere svaert at vinde dens\n"
    "tillid. Den er dog yderst populaer pga. sit\n"
    "soede udseende og adfaerd.");
...
const u8 gMawilePokedexText[] = _(
    ...
    "fjender i sikkerhed, saa bider den med\n"
    "sit enorme, ubarmhjertige kaebber.");

const u8 gMawilePokedexTextUnused[] = _("");

const u8 gAronPokedexText[] = _(
    "Den spiser jern for at bygge sin staalkrop.\n"
    "Den er en plage der stiger ned fra bjerge\n"
    "for at aede broer og jernbanespor.");

const u8 gAronPokedexTextUnused[] = _("");

const u8 gLaironPokedexText[] = _(
    "Den viser rutinemaessigt sin styrke med\n"
    "stoerrelsen af gnister den skaber ved at\n"
    "ramle sin staalkrop ind i klippeblokke.");

const u8 gLaironPokedexTextUnused[] = _("");

const u8 gAggronPokedexText[] = _(
    "Den kraever et stort bjerg som sit eneste\n"
    "territorium. Den taever ubarmhjertigt dem\n"
...
const u8 gMedititePokedexText[] = _(
    ...
    "traening over. Den oeger sin indre styrke\n"
    "gennem meditation.");

const u8 gMedititePokedexTextUnused[] = _("");

const u8 gMedichamPokedexText[] = _(
    "Den undgaar elegant angreb med danselignende\n"
    "trin og affyrer saa et oedelaeggende slag\n"
    "i samme bevaegelse.");
...
const u8 gManectricPokedexText[] = _(
    "Den viser sig sjaeldent for mennesker. Det\n"
    "siges at den redegger hvor lynet er slaaet\n"
    "ned.");

const u8 gManectricPokedexTextUnused[] = _("");

const u8 gPluslePokedexText[] = _(
    "Den hepper paa partnere mens den spreder\n"
    "gnister fra kroppen. Den kravler op ad\n"
    "telefonstolper for at optage stroem.");

const u8 gPluslePokedexTextUnused[] = _("");

const u8 gMinunPokedexText[] = _(
    "Dens aversion mod vand faar den til at soege\n"
    "ly under tagskaegget i regnvejr. Den bruger\n"
...
const u8 gSwalotPokedexText[] = _(
    "Den kan sluge et daek helt i een mundfuld.\n"
    "Den udskiller en gruelig giftig vaeske fra\n"
    "porerne paa kroppen.");

const u8 gSwalotPokedexTextUnused[] = _("");

const u8 gCarvanhaPokedexText[] = _(
    "Den lever i massive floder der loeber gennem\n"
    "jungler. Den svaermer om bytte der kommer\n"
    "ind i dens territorium.");

const u8 gCarvanhaPokedexTextUnused[] = _("");

const u8 gSharpedoPokedexText[] = _(
    "Havets boelle med hugtaender der knuser\n"
    "jern. Den svommer ved at sproejte vand\n"
    "ud bagfra.");

const u8 gSharpedoPokedexTextUnused[] = _("");

const u8 gWailmerPokedexText[] = _(
    "Naar den suger store maengder havvand ind,\n"
...
const u8 gWailordPokedexText[] = _(
    "Den er blandt de stoerste af alle POKeMON.\n"
...
const u8 gNumelPokedexText[] = _(
    "Magma paa naesten 2.200 grader Fahrenheit\n"
    "lober gennem dens krop. Bliver den kold,\n"
    "haerdner magmaen og bremser den.");

const u8 gNumelPokedexTextUnused[] = _("");

const u8 gCameruptPokedexText[] = _(
    "Bliver den vred, udbraeder puklene paa\n"
...
const u8 gTorkoalPokedexText[] = _(
    "Den braender kul inde i sit skjold. Angribes\n"
    "den, braekker den tyk, sort roeg og flygter.");

const u8 gTorkoalPokedexTextUnused[] = _("");

const u8 gSpoinkPokedexText[] = _(
    "Den doer tilsyneladende hvis den stopper\n"
    "med at hoppe. Den baerer en perle fra\n"
    "CLAMPERL paa hovedet.");

const u8 gSpoinkPokedexTextUnused[] = _("");

const u8 gGrumpigPokedexText[] = _(
    "Den kan faa kontrol over fjender med\n"
    "underlige dansetrin. De sorte perler paa\n"
    "panden er aedelsten.");
...
const u8 gSpindaPokedexText[] = _(
    ...
    "moenstere. Den forvirrer fjender med sine\n"
    "vralende bevaegelser.");

const u8 gSpindaPokedexTextUnused[] = _("");

const u8 gTrapinchPokedexText[] = _(
    "Den lever i torre oerkener. Den laver en\n"
    "skraanende faldgrube i sandet hvor den\n"
    "taalmodigt venter paa bytte.");

const u8 gTrapinchPokedexTextUnused[] = _("");

const u8 gVibravaPokedexText[] = _(
    "Den skaber ultralydsboelger ved voldsomt at\n"
    "slaa med vingerne. Efter at have faet byttet\n"
    "til at besvime, saetter den det under syre.");

const u8 gVibravaPokedexTextUnused[] = _("");

const u8 gFlygonPokedexText[] = _(
    "Den skjuler sig ved at sparke oerkensand op\n"
    "med vingerne. Roede daekker skaermer oejenene\n"
    "mod sand.");

const u8 gFlygonPokedexTextUnused[] = _("");

const u8 gCacneaPokedexText[] = _(
    "Den foretraekker haarde miljoeer som oerkener.\n"
    "Den kan overleve 30 dage paa vand lagret\n"
    "i kroppen.");

const u8 gCacneaPokedexTextUnused[] = _("");

const u8 gCacturnePokedexText[] = _(
    "Den lever i oerkener. Den bliver aktiv om\n"
    "natten naar den jager bytte udmaettet af\n"
    "oerkenens hede.");
...
const u8 gSwabluPokedexText[] = _(
    ...
    "goere sig ren hvis den bliver snavset.");

const u8 gSwabluPokedexTextUnused[] = _("");

const u8 gAltariaPokedexText[] = _(
    "Hoerer du en smuk melodi klinge dybt mellem\n"
...
const u8 gZangoosePokedexText[] = _(
    "Moeder den en SEVIPER, rejser pelsen sig og\n"
    "den indtager kampstilling. Dens skarpe\n"
    "kloer er dens bedste vaaben.");

const u8 gZangoosePokedexTextUnused[] = _("");

const u8 gSeviperPokedexText[] = _(
    "Den hvaesser sin svaerdlignende hale paa\n"
    "haarde klipper. Den gemmer sig i hoejt graes\n"
    "og slaaer uforsigtigt bytte med giftige hugtaender.");

const u8 gSeviperPokedexTextUnused[] = _("");

const u8 gLunatonePokedexText[] = _(
    "Dens sundhed ebber og flyder med maane-\n"
    "cyklussen. Den flyder over med kraft naar\n"
    "den udsaettes for fuldmaanens lys.");

const u8 gLunatonePokedexTextUnused[] = _("");

const u8 gSolrockPokedexText[] = _(
    "Den optager solenergi om dagen. Altid\n"
    "udtryksloes kan den maerke hvad fjenden\n"
    "taenker.");

const u8 gSolrockPokedexTextUnused[] = _("");

const u8 gBarboachPokedexText[] = _(
    "Den undersoeger mudrede flodlejer med sine\n"
...
const u8 gWhiscashPokedexText[] = _(
    "Den laver rede paa bunden af sumpe. Den\n"
...
const u8 gCorphishPokedexText[] = _(
    "Den kom fra oversoeen. Den er et meget\n"
    "haardfoert vaesen der hurtigt formerer sig,\n"
    "selv i forurenede vandloeb.");

const u8 gCorphishPokedexTextUnused[] = _("");

const u8 gCrawdauntPokedexText[] = _(
    "En haard kunde der vildt svinger sine\n"
    "kaempe kloer. Den siges at vaere ekstremt\n"
    "svaer at opdrage.");

const u8 gCrawdauntPokedexTextUnused[] = _("");

const u8 gBaltoyPokedexText[] = _(
    "Den blev opdaget i oldtidsruiner. Naar den\n"
    "bevaeger sig, snurrer den konstant. Den\n"
    "staar paa een fod selv naar den sover.");

const u8 gBaltoyPokedexTextUnused[] = _("");

const u8 gClaydolPokedexText[] = _(
    "Den lader til at vaere foedt af lerdukker\n"
    "lavet af oldtidens folk. Den bruger\n"
    "telekinese til at svaerve og bevaege sig.");

const u8 gClaydolPokedexTextUnused[] = _("");

const u8 gLileepPokedexText[] = _(
    "Den uddoede for omkring 100 millioner aar\n"
...
const u8 gCradilyPokedexText[] = _(
    ...
    "Den saetter derefter byttet under staerk\n"
    "syre foer den spiser.");

const u8 gCradilyPokedexTextUnused[] = _("");

const u8 gAnorithPokedexText[] = _(
    "Den er en slags POKeMON-forfader. Den\n"
    "bruger sine udstrakte kloer til at fange\n"
    "bytte gemt mellem klipper paa havbunden.");

const u8 gAnorithPokedexTextUnused[] = _("");

const u8 gArmaldoPokedexText[] = _(
    "Beskyttet af et haardt skjold er kroppen\n"
...
const u8 gFeebasPokedexText[] = _(
    "Haanet for sit lurvede udseende bliver den\n"
...
const u8 gMiloticPokedexText[] = _(
    ...
    "siges at glemme deres kampaand.");

const u8 gMiloticPokedexTextUnused[] = _("");

const u8 gCastformPokedexText[] = _(
    "Den har evnen til at aendre sin form til\n"
    "solen, regnen eller en snesky, afhaengigt\n"
    "af vejret.");

const u8 gCastformPokedexTextUnused[] = _("");

const u8 gKecleonPokedexText[] = _(
    "Den aendrer kropfarve for at smelte ind med\n"
    "omgivelserne. Den aendrer ogsaa farve hvis\n"
    "den er glad eller bedroevet.");

const u8 gKecleonPokedexTextUnused[] = _("");

const u8 gShuppetPokedexText[] = _(
    "Den elsker at naere sig af foelelser som\n"
...
const u8 gBanettePokedexText[] = _(
    "Staerke hadske foelelser forvandlede en\n"
...
const u8 gDuskullPokedexText[] = _(
    "Den goer sig usynlig og sniger sig stille\n"
    "ind paa bytte. Den kan glide gennem\n"
    "tykke vaegge.");

const u8 gDuskullPokedexTextUnused[] = _("");

const u8 gDusclopsPokedexText[] = _(
    "Kroppen er helt hul. Naar den aabner munden,\n"
...
const u8 gChimechoPokedexText[] = _(
    "Den rejser ved at ride paa vinde. Den\n"
    "bruger klogt sin lange hale til at plukke\n"
    "noedder og baer, som den elsker at spise.");

const u8 gChimechoPokedexTextUnused[] = _("");

const u8 gAbsolPokedexText[] = _(
    "Den viser sig naar den maerker en forestaaende\n"
...
const u8 gWynautPokedexText[] = _(
    "Den bevaeger sig gerne i flok med andre.\n"
    "De samles i taet gruppe for at sove i en\n"
    "hule.");

const u8 gWynautPokedexTextUnused[] = _("");

const u8 gSnoruntPokedexText[] = _(
    "Det siges at et hjem besoegt af en SNORUNT\n"
    "vil blomstre. Den taaler kulde paa minus\n"
...
const u8 gGlaliePokedexText[] = _(
    ...
    "ved ild. Den kan oejeblikkeligt fryse\n"
    "fugt i atmosfaeren.");

const u8 gGlaliePokedexTextUnused[] = _("");

const u8 gSphealPokedexText[] = _(
    "Kroppen er daekket af bloed pels. Pelsen\n"
    "holder den fra at fryse naar den ruller\n"
    "paa is.");

const u8 gSphealPokedexTextUnused[] = _("");

const u8 gSealeoPokedexText[] = _(
    "Den roerer nye ting med naesen for at teste\n"
    "lugt og foelse. Den leger ved at snurre\n"
    "SPHEAL paa naesen.");
...
const u8 gWalreinPokedexText[] = _(
    ...
    "isfolde med sine store stoedtaender. Den er\n"
    "beskyttet af sit tykke spaeklag.");

const u8 gWalreinPokedexTextUnused[] = _("");

const u8 gClamperlPokedexText[] = _(
    "Den er beskyttet af et staert skal. Een gang\n"
...
const u8 gHuntailPokedexText[] = _(
    ...
    "naar ned. Den lyser med sin lille fiskelignende\n"
    "hale for at tiltraekke bytte.");

const u8 gHuntailPokedexTextUnused[] = _("");

const u8 gGorebyssPokedexText[] = _(
    "Dens svommeform er udsoegt elegant. Med sin\n"
    "tynde mund aeder den tang der vokser\n"
    "mellem klipper.");

const u8 gGorebyssPokedexTextUnused[] = _("");

const u8 gRelicanthPokedexText[] = _(
    "Den har vaeret uaendret i 100 millioner aar.\n"
...
const u8 gLuvdiscPokedexText[] = _(
    "Under ynglesaesonen samles utallige LUVDISC\n"
    "ved koralrev og farver vandet roedt.");

const u8 gLuvdiscPokedexTextUnused[] = _("");

const u8 gBagonPokedexText[] = _(
    "Dens staalhaarde hoved kan splintre klipper.\n"
    "Den haaber laengselsfuldt paa at faa vinger\n"
    "saa den kan flyve.");

const u8 gBagonPokedexTextUnused[] = _("");

const u8 gShelgonPokedexText[] = _(
    "Dens panserdaekkede krop faar alle angreb til\n"
    "at prelle af. Panseret er dog for haardt og\n"
    "goer den tung og noget doeven.");

const u8 gShelgonPokedexTextUnused[] = _("");

const u8 gSalamencePokedexText[] = _(
    "Den bliver ukontrollerbar naar den er rasende.\n"
    "Den oedelaegger alt med sine revende kloer\n"
    "og ild.");

const u8 gSalamencePokedexTextUnused[] = _("");

const u8 gBeldumPokedexText[] = _(
    "Den bruger magnetiske boelger til at tale med\n"
...
const u8 gMetangPokedexText[] = _(
    "Den svaever i luften ved hjaelp af magnetisme.\n"
    "Kroppen er saa haard at selv et sammenstoed\n"
...
const u8 gRegicePokedexText[] = _(
    "Forskning afsloerede at kroppen er lavet af\n"
...
const u8 gRegisteelPokedexText[] = _(
    ...
    "haerdnede under tryk under jorden over\n"
    "titusinder af aar.");
...
const u8 gLatiasPokedexText[] = _(
    ...
    "Den aendrer udseende ved hjaelp af sit dun\n"
    "der bryder lyset.");
...
const u8 gLatiosPokedexText[] = _(
    ...
    "at kaempe. Med forbenene trukket ind kan\n"
...
const u8 gJirachiPokedexText[] = _(
    "Den siges at goere ethvert oensk opfyldt.\n"
    "Den er vaagen i kun syv dage ud af tusind\n"
    "aar.");

const u8 gJirachiPokedexTextUnused[] = _("");

const u8 gDeoxysPokedexText[] = _(
    "Naar den skifter form, vises et nordlys.\n"
    "Den absorberer angreb ved at aendre sin\n"
    "cellulaere struktur.");
