...
static const u8 sStenchDescription[] = _("Hjælper med at drive vilde POKéMON væk.");
...
static const u8 sBattleArmorDescription[] = _("Blokerer kritiske træffere.");
...
static const u8 sSandVeilDescription[] = _("Øger undvigelse i sandstorm.");
static const u8 sStaticDescription[] = _("Lammelse ved berøring.");
static const u8 sVoltAbsorbDescription[] = _("Gør strøm til KP.");
static const u8 sWaterAbsorbDescription[] = _("Gør vand til KP.");
static const u8 sObliviousDescription[] = _("Forhindrer tiltrækning.");
static const u8 sCloudNineDescription[] = _("Ophæver vejreffekter.");
...
static const u8 sFlashFireDescription[] = _("Stærkere ved ild-treffer.");
...
static const u8 sIntimidateDescription[] = _("Sænker fjendens ANGREB.");
static const u8 sShadowTagDescription[] = _("Forhindrer fjendens flugt.");
static const u8 sRoughSkinDescription[] = _("Skader ved berøring.");
...
static const u8 sEffectSporeDescription[] = _("Efterlader sporer ved berøring.");
...
static const u8 sSereneGraceDescription[] = _("Øger tilleggseffekter.");
static const u8 sSwiftSwimDescription[] = _("Øger HASTIGHED i regn.");
static const u8 sChlorophyllDescription[] = _("Øger HASTIGHED i solskin.");
static const u8 sIlluminateDescription[] = _("Øger mødningsfrekvens.");
static const u8 sTraceDescription[] = _("Kopierer særlig evne.");
static const u8 sHugePowerDescription[] = _("Øger ANGREB.");
static const u8 sPoisonPointDescription[] = _("Forgifter fjende ved berøring.");
...
static const u8 sMagnetPullDescription[] = _("Fanger STÂL-type POKéMON.");
...
static const u8 sPressureDescription[] = _("Øger fjendens PP-forbrug.");
static const u8 sThickFatDescription[] = _("Varme- og kuldeskærm.");
static const u8 sEarlyBirdDescription[] = _("Vâgner hurtigt fra søvn.");
...
static const u8 sCuteCharmDescription[] = _("Gør betaget ved berøring.");
static const u8 sPlusDescription[] = _("Stærkere med MINUS.");
static const u8 sMinusDescription[] = _("Stærkere med PLUS.");
...
static const u8 sGutsDescription[] = _("Øger ANGREB hvis lidende.");
static const u8 sMarvelScaleDescription[] = _("Øger FORSVAR hvis lidende.");
static const u8 sLiquidOozeDescription[] = _("Dræn giver skade.");
static const u8 sOvergrowDescription[] = _("Øger GRÆS-angreb i nød.");
static const u8 sBlazeDescription[] = _("Øger ILD-angreb i nød.");
static const u8 sTorrentDescription[] = _("Øger VAND-angreb i nød.");
static const u8 sSwarmDescription[] = _("Øger INSEKT-angreb i nød.");
...
static const u8 sShellArmorDescription[] = _("Blokerer kritiske træffere.");
static const u8 sCacophonyDescription[] = _("Undgâr lyd-baserede angreb.");
static const u8 sAirLockDescription[] = _("Ophæver vejreffekter.");
