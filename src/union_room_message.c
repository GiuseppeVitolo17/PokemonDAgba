...
ALIGNED(4) static const u8 sText_OtherTrainerUnavailableNow[] = _("Den anden TRÆNER ser ikke\nud til at være tilgængelig…\p");
ALIGNED(4) static const u8 sText_CantTransmitTrainerTooFar[] = _("Du kan ikke sende til en TRÆNER\nder er for langt væk.\p");
ALIGNED(4) static const u8 sText_TrainersNotReadyYet[] = _("Den anden TRÆNER er ikke\nklar endnu.\p");
...
ALIGNED(4) static const u8 sText_MemberNoLongerAvailable[] = _("Et medlem kan ikke længere\nvære tilgængelig.\p");
...
ALIGNED(4) static const u8 sText_TrainerAppearsUnavailable[] = _("Den anden TRÆNER ser ikke\nud til at være tilgængelig…\p");
...
ALIGNED(4) const u8 gText_UR_ShowTrainerCard[] = _("Den anden TRÆNER viste\ndig sit TRÆNERKORT.\pVil du vise dit\nTRÆNERKORT?");
ALIGNED(4) const u8 gText_UR_BattleChallenge[] = _("Den anden TRÆNER udfordrer\ndig til kamp.\pAccepterer du kamp-\nudfordringen?");
ALIGNED(4) const u8 gText_UR_ChatInvitation[] = _("Den anden TRÆNER inviterer\ndig til chat.\pAccepterer du chat-\ninvitationen?");
...
ALIGNED(4) static const u8 sText_ShowTrainerCardMale[] = _("Selvfølgelig! Her er mit “Greetings,” TRÆNERKORT.");
ALIGNED(4) static const u8 sText_WaitForBattleFemale[] = _("En kamp? Selvfølgelig, men jeg\nskal lige gøre mig klar.");
...
ALIGNED(4) const u8 gText_UR_ChooseRequestedMonType[] = _("Vælg den type POKéMON\ndu vil have i byttet.\n");
...
ALIGNED(4) const u8 gText_UR_RegistraionCompleted[] = _("Registrering er gennemført.\p");
...
ALIGNED(4) const u8 gText_UR_DontHaveEggTrainerWants[] = _("Du har ikke et ÆG som\n{STR_VAR_1} vil have.\p");
...
ALIGNED(4) const u8 gText_UR_EggTrade[] = _("ÆG BYTTE");
ALIGNED(4) const u8 gText_UR_ChooseJoinCancel[] = _("{DPAD_UPDOWN}VALG  {A_BUTTON}DELTAG  {B_BUTTON}ANNULLER");
ALIGNED(4) const u8 gText_UR_ChooseTrainer[] = _("Vælg en TRÆNER.");
ALIGNED(4) static const u8 sText_ChooseTrainerSingleBattle[] = _("Vælg en TRÆNER til\neen ENKELTKAMP.");
ALIGNED(4) static const u8 sText_ChooseTrainerDoubleBattle[] = _("Vælg en TRÆNER til\neen Dobbeltkamp.");
ALIGNED(4) static const u8 sText_ChooseLeaderMultiBattle[] = _("Vælg LEDEREN til\neen MULTIKAMP.");
ALIGNED(4) static const u8 sText_ChooseTrainerToTradeWith[] = _("Vælg TRÆNEREN du vil\nbytte med.");
ALIGNED(4) static const u8 sText_ChooseTrainerToShareWonderCards[] = _("Vælg TRÆNEREN der deler\nWONDER CARDS.");
ALIGNED(4) static const u8 sText_ChooseTrainerToShareWonderNews[] = _("Vælg TRÆNEREN der deler\nWONDER NEWS.");
