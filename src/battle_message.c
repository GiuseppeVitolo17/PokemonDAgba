...
static const u8 sText_UseNextPkmn[] = _("Brug näste POKéMON?");
...
static const u8 sText_PkmnHearingFluteAwoke[] = _("POKéMON der hörte FLÖJTEN\nvâgnede!");
static const u8 sText_YouThrowABallNowRight[] = _("Du kaster en BOLD nu, ikke?\nJeg… jeg gör mit bedste!");
const u8 gText_ForPetesSake[] = _("OAK: Ah, for dän…\nSâdan trängende som altid.\p{B_PLAYER_NAME}.\pDu har aldrig haft en POKéMON-kamp\nför, vel?\pEn POKéMON-kamp er nâr TRÄNERe\nlader POKéMON kämpe mod hinanden.\p");
const u8 gText_TheTrainerThat[] = _("TRÄNERen der fâr den anden\nTRÄNERs POKéMON til at besvime ved at\lsänke deres KP til “0,” 0, vinder.\p");
