...
const u8 gText_DexCategory_GrasslandPkmn[] = _("Graesland POKéMON");
...
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("Ujaevnt terraen POKéMON");
const u8 gText_DexCategory_UrbanPkmn[] = _("By POKéMON");
const u8 gText_DexCategory_RarePkmn[] = _("Sjaelden POKéMON");
